"""
Setup Module to setup Python Handlers for the jupyterlab-pbs extension.
"""
import os
...
data_files_spec = [
    ...
    ('etc/jupyter/jupyter_notebook_config.d', 'jupyter-config', 'jupyterlab_pbs.json'),
]
...
setup_args = dict(
    ...
    install_requires=['jupyterlab~=2.0',],
    zip_safe=False,
